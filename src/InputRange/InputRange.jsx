...
class InputRange extends PureComponent {
    ...
    handleSliderChange = (e) => {
        ...
        let slider = this.sliderNode,
            inputRangeOutputElement = this.outputNode,
            sliderWidth = slider.offsetWidth,
            sliderVal = slider.value,
            newPoint = (sliderVal - this.props.min) / (this.props.max - this.props.min),
            newPlacePx, renderValue;
            ...
            <div className={className || 'input-range'}>
                ...
                <div className="input-range-group">
                    ...
                    <div className="input-range-content">
                        <div className="input-range-output" ref={node => this.outputNode = node}></div>
                        <div className="input-range-track-active" ref={node => this.trackNode = node}></div>
                    </div>
                </div>
            </div>
        );
