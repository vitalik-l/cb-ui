...
export const Tabs = React.forwardRef((props, ref) => {
  ...
  return (
    <div className={clsx('cb-MobileTabs', className)} {...restProps} ref={ref}>
      {displayScrollButtons && (
        <ButtonBase
          onClick={handleStartScrollClick}
          className="cb-MobileTabs-scroll-button"
          style={{ visibility: displayScroll.start ? 'visible' : 'hidden' }}
        >
          {scrollLeftIcon}
        </ButtonBase>
      )}
      <div className="cb-MobileTabs-scroller" ref={tabsRef} onScroll={handleTabsScroll}>
        {childrenItems}
      </div>
      {displayScrollButtons && (
        <ButtonBase
