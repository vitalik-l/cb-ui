...
const srcPath = fs.existsSync(`./src/${packageName}/src`)
  ? `./src/${packageName}/src`
  : `./src/${packageName}`;
...
const tsconfigFile = fs.existsSync(`./src/${packageName}/tsconfig.build.json`)
  ? `./src/${packageName}/tsconfig.build.json`
  : fs.existsSync(`./src/${packageName}/tsconfig.json`)
  ? `./src/${packageName}/tsconfig.json`
  : '';
